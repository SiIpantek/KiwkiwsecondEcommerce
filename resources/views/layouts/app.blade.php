...
<body class="bg-slate-50" x-data="{ open: false, profileOpen: false, showMessage: true }" x-init="setTimeout(() => { showMessage = false; }, 5000)">
    ...
    @if (session('success') || session('error'))
        <div 
            ...
            class="fixed top-16 left-1/2 -translate-x-1/2 z-[45] max-w-sm p-4"
        >
            @if (session('success'))
