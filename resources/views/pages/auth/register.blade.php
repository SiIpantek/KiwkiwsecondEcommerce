...
<section class="">
  <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
    <section class="relative flex items-end h-32 bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
      <img
        alt=""
        src="{{ asset('images/auth/register.jpeg') }}"
        class="absolute inset-0 object-cover w-full h-full opacity-90 brightness-50"
      />
      ...
      <div class="hidden lg:relative lg:block lg:p-12">
        ...
        <h2 class="mt-6 text-2xl font-bold text-white sm:text-3xl md:text-4xl">
          Selamat datang di Kiw Kiw E-Commerce
        </h2>
        
        <p class="mt-4 leading-relaxed text-white/90">
          Selamat datang di Kiw Kiw E-Commerce. Kami menyediakan platform jual-beli online yang mudah dan aman.
        </p>>
      </div>
    </section>
    ...
    >
      <div class="max-w-xl lg:w-full lg:max-w-3xl">
        <div class="relative block -mt-16 lg:hidden">
          ...
          <p class="mt-4 leading-relaxed text-gray-500">
            Temukan produk yang Anda butuhkan dengan mudah dan aman di E-Commerce.
          </p>
        </div>
        ...
        <form action="{{ route('register_post') }}" method="POST" class="grid w-full grid-cols-6 gap-6 max-sm:mt-4">
          ...
          <div class="col-span-6">
            ...
            @if ($errors->has('phone'))
              <div class="mt-1 text-sm text-red-500">{{ $errors->first('phone') }}</div>
            @endif
          </div>
          ...
          <div class="flex flex-col col-span-6 gap-4">
            <button
              class="px-12 py-3 text-sm font-medium text-white transition border bg-slate-950 border-slate-950 shrink-0 hover:bg-transparent hover:text-slate-950 focus:outline-none focus:ring active:text-slate-900"
            >
              Buat Akun
            </button>
