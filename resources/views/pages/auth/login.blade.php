...
<section class="">
  <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
    <section class="relative flex items-end h-32 bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
      <img
        alt=""
        src="{{ asset('images/auth/login.jpeg') }}"
      ...
      <div class="hidden lg:relative lg:block lg:p-12">
        ...
        <p class="mt-4 leading-relaxed text-white/90">
          Temukan produk yang Anda butuhkan dengan mudah dan aman di Kiw Kiw E-Commerce.
        </p>
      </div>
    </section>
    ...
    >
      <div class="max-w-xl lg:max-w-3xl lg:w-full">
        <div class="relative block -mt-16 lg:hidden">
          ...
          <h1 class="mt-2 text-2xl font-bold text-gray-900 sm:text-3xl md:text-4xl">
            Selamat datang di E-Commerce 🛍️
          </h1>
          
          <p class="mt-4 leading-relaxed text-gray-500">
            Belanja online dengan mudah dan aman di E-Commerce kami.
          </p>
        </div>
